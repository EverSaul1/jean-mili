...
import {INVITATION_CONFIG_NAVIDAD} from "../../shared/invitation-config-navidad";
...
export class NavidadComponent implements OnInit, AfterViewInit, OnDestroy {

  @ViewChildren('foto') fotos!: QueryList<ElementRef<HTMLImageElement>>;
  invitation = INVITATION_CONFIG_NAVIDAD;
